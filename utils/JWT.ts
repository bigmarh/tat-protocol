import { TokenHeader,TokenPayload } from '@tat-protocol/types';
 ...
 */
export function serializeToken(header: TokenHeader, payload: TokenPayload, signature: string): string {
 ...
 */
export function deserializeToken(jwt: string): { header: TokenHeader; payload: TokenPayload; signature: string } {
