import { NWPCContext, NWPCRequest, NWPCResponse, NWPCHandler, NWPCRoute, NWPCResponseObject } from './NWPCResponseTypes';
...
export class NWPCRouter {
     ...
     */
    public async handle(request: NWPCRequest, context: NWPCContext, res: NWPCResponseObject): Promise<NWPCResponse> {
