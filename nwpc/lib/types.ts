...
export type NWPCHandler = (request: NWPCRequest, context: NWPCContext, res: NWPCResponseObject, next: () => Promise<NWPCResponse>) => Promise<NWPCResponse>;

export type NWPCMiddleware = (request: NWPCRequest, context: NWPCContext, res: NWPCResponseObject, next: () => Promise<NWPCResponse>) => Promise<NWPCResponse>;
