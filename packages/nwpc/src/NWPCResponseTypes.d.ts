...
export type MessageHook = (message: NWPCMessageData, context: NWPCContext) => Promise<boolean>;
...
export declare class NWPCResponseObject {
    ...
    error(code: number, message: string, params?: string, recipient?: string | string[]): Promise<NWPCResponse>;
    notFound(message?: string, recipient?: string | string[]): Promise<NWPCResponse>;
    badRequest(message?: string, recipient?: string | string[]): Promise<NWPCResponse>;
    unauthorized(message?: string, recipient?: string | string[]): Promise<NWPCResponse>;
    internalError(message?: string, recipient?: string | string[]): Promise<NWPCResponse>;
}
