...
import { NWPCResponse, NWPCResponseObject, NWPCConfig, NWPCRequest, NWPCContext } from "./NWPCResponseTypes";
...
export declare class NWPCServer extends NWPCBase {
    ...
    handleRequest(request: NWPCRequest, context: NWPCContext, res: NWPCResponseObject): Promise<void>;
}
